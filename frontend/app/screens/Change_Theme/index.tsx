...
export default function ReusableGridScreen() {
  ...
  const moveScroll = (
    ...
    scrollRefs[tab].current?.scrollTo({
      x: next,
      animated: true,
    });
